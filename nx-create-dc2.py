...
#variables as needed
sel_vlans = "2-20,99"
sel_po = "interface port-channel 10"
sel_intf = "interface Ethernet 1/2"
...
vlan_payload={
  "ins_api": {
    ...
    "input": "conf t",
    "input": sel_vlans,
    "input": "vlan 10 ;name test_segment ;vlan 20 ;name peer-keepalive ;vlan 99 ;name native",
    "output_format": "json"
  }
}
...
print "***** port-channel 10 json-rpc"
# Create Portchannels
po10_myheaders={'content-type':'application/json-rpc'}
po10_payload=[
  {
    "jsonrpc": "2.0",
    "method": "cli",
  ...
  },
  {
    ...
    "method": "cli",
    "params": {
      "cmd": "switchport trunk allowed vlan 2-20",
      "version": 1
    },
    "id": 5
  }
...
po10_payload={
  "ins_api": {
    ...
    "input": "conf t",
    "input": sel_po,
    "input": "switchport mode trunk ;switchport trunk native vlan 99 ;switchport trunk allowed vlan 2-20",
    "output_format": "json"
  }
}
po10_response = requests.post(url,data=json.dumps(po10_payload), headers=po10_myheaders,auth=(switchuser,switchpassword)).json()
...
trunks_payload={
  "ins_api": {
    ...
    "input": "conf t",
    "input": sel_intf,
    "input": "switchport mode trunk ;switchport trunk native vlan 99 ;"
